...
class CekDokumenAdapter(private val context: Context, val cekDokumenViewModel: CekDokumenViewModel, private var mListener: onItemClickListener, val listener: (CekDokumenModel) -> Unit)
    : RecyclerView.Adapter<CekDokumenAdapter.CekDokumenViewHolder>(){

    private var CekDokumen: List<CekDokumenModel> = cekDokumenViewModel.mData
